                     ...
                     _In_ int       nCmdShow)
{
    ...
    // GetMessage
    // 메세지큐에서 메세지 확인 될 때가지 대기
    // msg.message == WM_QUIT 인 경우 fals를 반환 -> 프로그램 종료
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   g_hwnd = CreateWindowW(szWindowClass, L"Virus Strike", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX,
